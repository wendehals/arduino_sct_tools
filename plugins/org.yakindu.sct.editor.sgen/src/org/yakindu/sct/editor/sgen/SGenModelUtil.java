...
public class SGenModelUtil {
	...
	public static FeatureParameter getFeatureParameter(final FeatureType featureType, final String name) {
		for (final FeatureParameter featureParameter : featureType.getParameters()) {
			if (name.equals(featureParameter.getName())) {
