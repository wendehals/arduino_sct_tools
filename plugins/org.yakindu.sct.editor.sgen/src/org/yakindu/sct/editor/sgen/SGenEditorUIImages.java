 ...
 */
public enum SGenEditorUIImages {

	GENERATOR_MODEL("icons/GeneratorModel.gif"); //$NON-NLS-1$

	private final String path;

	private SGenEditorUIImages(final String path) {
		this.path = path;
	}
	 ...
	 */
	public Image image() {
		final ImageRegistry imageRegistry = SGenEditorUIPlugin.getDefault().getImageRegistry();
	...
	private void addImageDescriptor() {
		final SGenEditorUIPlugin plugin = SGenEditorUIPlugin.getDefault();
